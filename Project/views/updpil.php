<?php
	if(isset($_POST['id'])){
		...
		$employe = $exitEmploye->getOnepilot();
	}else{
		Redirect::to('home');
	}
	if(isset($_POST['submit'])){
		$exitEmploye = new PilotController();
		$exitEmploye->updatepilot();
	}
?>
<div class="container">
	<div class="row my-4">
		<div class="col-md-8 mx-auto">
			<div class="card">
				<div class="card-header">Update pilot</div>
				<div class="card-body bg-light">
                    ...
                    <div class="form-group">
                        ...
                        <div class="form-group">
							<input type="hidden" class="form-control" name="id" value="<?php echo $employe->pilot_id;?>"></input>
						</div>
						<div class="form-group">
